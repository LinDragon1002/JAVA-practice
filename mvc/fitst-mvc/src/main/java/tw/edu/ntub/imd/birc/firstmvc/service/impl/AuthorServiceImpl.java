...
public class AuthorServiceImpl extends BaseServiceImpl<AuthorBean, Author, Integer> implements AuthorService {
    ...
    public AuthorServiceImpl(AuthorDAO authorDAO, AuthorTransformer authorTransformer) {
        super(authorDAO, authorTransformer);
    ...
    public List<AuthorBean> findAllByName(@Param("id") Integer id){
        return CollectionUtils.map(authorDAO.findAllByName(id), transformer::transferToBean);
    }
