...
@RequestMapping(path = "/birc")
// 建構controller會用到要使用的service
public class MemberController_birc {
...
//                .build();
    ...
    @GetMapping(path = "/sp2")
    public ResponseEntity<String> searchbirc() {
        return ResponseEntityBuilder.success()
                .message("you")
                .build();
    }

    @PostMapping(path = "/sp1")
    public ResponseEntity<String> postbirc() {
        return ResponseEntityBuilder.success()
                .message("py")
                .build();
    }
